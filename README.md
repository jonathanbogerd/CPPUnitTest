...
## Requirements
CPPUnitTest was built and tested with Clang 21.1.8 and libstdc++. Due to differences in module implementation between the compilers, this project will probably not compile with GCC or MSVC.
